  ...
  return (
    <div className="bg-[#00a63e] h-[42.667px] relative shrink-0 w-[118.396px]" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[42.667px] relative w-[118.396px]">
        <p className="absolute font-['Arimo:Regular','Noto_Sans_Symbols2:Regular',sans-serif] font-normal leading-[24px] left-[17.33px] text-[16px] text-nowrap text-white top-[7.67px] whitespace-pre">✓ APPROVE</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="bg-[#e7000b] h-[42.667px] relative shrink-0 w-[101.896px]" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[42.667px] relative w-[101.896px]">
        <p className="absolute font-['Arimo:Regular','Noto_Sans_Symbols2:Regular',sans-serif] font-normal leading-[24px] left-[17.33px] text-[16px] text-nowrap text-white top-[7.67px] whitespace-pre">✗ REJECT</p>
      </div>
    </div>
  );
}
