...
function Container30() {
  return (
    <div className="absolute h-[42.667px] left-0 top-0 w-[1416px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[1.333px] border-black border-solid inset-0 pointer-events-none" />
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[24px] left-[9.33px] text-[16px] text-neutral-950 text-nowrap top-[7.67px] whitespace-pre">ASSIGN STUDENTS TO TEACHERS</p>
    </div>
  );
}
...
function Container31() {
  return (
    <div className="absolute h-[42.667px] left-[-0.33px] top-[99.67px] w-[1416px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[1.333px] border-black border-solid inset-0 pointer-events-none" />
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[24px] left-[9.33px] text-[16px] text-neutral-950 text-nowrap top-[7.67px] whitespace-pre">UNASSIGNED (8):</p>
    </div>
  );
}
...
function Container33() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Cousine:Regular',sans-serif] h-[31px] leading-[24px] left-[0.33px] not-italic text-[16px] text-neutral-950 top-[-0.67px] w-[91px]">Student 1</p>
    </div>
  );
}
...
function Button9() {
  return (
    <div className="h-[42px] relative shrink-0 w-[114px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[1.333px] border-black border-solid inset-0 pointer-events-none" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[42px] relative w-[114px]">
        <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[24px] left-[13px] text-[16px] text-neutral-950 text-nowrap top-[9px] whitespace-pre">View Details</p>
      </div>
    </div>
  );
}
...
function Container41() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Cousine:Regular',sans-serif] h-[31px] leading-[24px] left-[0.33px] not-italic text-[16px] text-neutral-950 top-[-0.33px] w-[91px]">Student 2</p>
    </div>
  );
}
...
function Container42() {
  return (
    <div className="content-stretch flex h-[20px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[14px] text-neutral-950 text-nowrap whitespace-pre">Grade 12</p>
    </div>
  );
}
...
function Container49() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Cousine:Regular',sans-serif] leading-[24px] left-[0.33px] not-italic text-[16px] text-neutral-950 top-0 w-[90px]">Student 3</p>
    </div>
  );
}
...
function Container50() {
  return (
    <div className="content-stretch flex h-[20px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[14px] text-neutral-950 text-nowrap whitespace-pre">Grade 7</p>
    </div>
  );
}
...
function Container57() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] h-[260px] items-start left-[-0.33px] top-[199.67px] w-[1416px]" data-name="Container">
      <Container39 />
      <Container47 />
      <Container56 />
    </div>
...
export default function DashboardAssignStudentsToTeachers() {
  return (
    <div className="bg-white relative size-full" data-name="Dashboard - Assign Students to Teachers">
      <App />
    </div>
  );
}