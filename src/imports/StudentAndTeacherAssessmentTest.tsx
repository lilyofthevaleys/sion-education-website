...
function Container21() {
  return (
    <div className="[grid-area:1_/_1] h-[694.667px] relative shrink-0" data-name="Container">
  ...
  return (
    <div className="h-[30.667px] relative shrink-0 w-[78.688px]" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[30.667px] relative w-[78.688px]">
        <p className="absolute font-['Arimo:Regular','Noto_Sans_Symbols:Regular',sans-serif] font-normal leading-[20px] left-[13.33px] text-[14px] text-neutral-950 text-nowrap top-[3.33px] whitespace-pre">⚑ MARK</p>
      </div>
    </div>
  );
}
...
function Container33() {
  return (
    <div className="[grid-area:1_/_2] content-stretch flex flex-col gap-[16px] h-[694.667px] items-start relative shrink-0" data-name="Container">
      <Container30 />
      <Container32 />
    </div>
  );
