...
export default function EditQuestion({ navigate, questionId }) {
  // Mock question data - in production this would come from backend
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F0F4FF] via-[#E8F0FE] to-[#F0F9FF]">
        ...
        <div className="max-w-[1400px] mx-auto px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="font-['Arimo'] text-2xl text-gray-900">Edit Test Question</h1>
                <p className="font-['Arimo'] text-sm text-gray-600">Question #{existingQuestion.id}</p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <motion.button
                ...
                className="bg-gradient-to-r from-blue-500 to-blue-600 text-white px-6 py-3 rounded-xl font-['Arimo'] shadow-lg hover:shadow-xl flex items-center gap-2"
              >
      ...
      <ConfirmationModal
        ...
        title="Save Changes"
        message="Are you sure you want to save the changes to this question?"
